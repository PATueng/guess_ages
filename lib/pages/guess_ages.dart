...
import 'package:guess_ages/services/api.dart';
import 'package:http/http.dart' as http;

class GuessAges extends StatefulWidget {
  static const String routeName = "/guess";

  const GuessAges({Key? key}) : super(key: key);

  @override
  _GuessAgesState createState() => _GuessAgesState();
}

class _GuessAgesState extends State<GuessAges> {
  double _years = 0.0;
  double _month = 0.0;
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Icon(Icons.check, size: 100.0, color: Colors.greenAccent,)
                            ],
                          ),
                        ),
                      ],
